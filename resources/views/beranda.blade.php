                ...
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    {{ $guru->profilGuru->namaGuruBK }} - Jumlah Laporan</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    {{ $guru->laporanBimbinganFromUser->count() }}</div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            @if ($prestasiTotal > 0)
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    Total Prestasi</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $prestasiTotal }}</div>
                            @endif
                        </div>
                        <div class="col-auto">
